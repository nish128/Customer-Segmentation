...
st.markdown('<div class="banner fade-in">Customer Segmentation Dashboard by Nisha Nayani</div>', unsafe_allow_html=True)
st.markdown('<div class="subtitle">Analyze and explore your customers with RFM metrics</div>', unsafe_allow_html=True)
