#!/usr/bin/env python3
"""
Script to recreate the Customer Segmentation Dashboard
Run this script in an empty folder to create all necessary files.
"""

import os

# Create requirements.txt
requirements = """pandas==2.3.1
numpy==2.3.1
plotly==6.2.0
dash==3.1.1
scikit-learn==1.7.1
...
setup_md = '''# Setup Instructions

1. Make sure you have the RFM_Clustered.csv file in this folder
2. Install dependencies: `pip install -r requirements.txt`  
3. Run dashboard: `python dashboard.py`
4. Open: http://localhost:8050

## If you don't have the CSV file:
You'll need to copy your RFM_Clustered.csv file here, or recreate it from your original customer segmentation project.
'''

def main():
    print("🎯 Creating Customer Segmentation Dashboard files...")
    ...
    print("1. Copy your RFM_Clustered.csv file here")
